        ...
        <div className="border border-white/15 p-4 sm:p-6 rounded-none bg-gradient-to-br from-zinc-900/50 to-zinc-800/50">
          <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a
              ...
              className="self-start sm:self-auto text-xs text-blue-400 hover:text-blue-300 underline underline-offset-2"
            >
              View Profile →
            </a>
          </div>
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                <div className="text-center p-2.5 sm:p-3 bg-white/5 rounded-sm border border-white/10">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3 text-center text-sm">
                <div className="p-2 sm:p-2.5 bg-green-500/10 rounded-sm border border-green-500/20">
                  <div className="text-xl font-bold text-green-400">
                    {stats.easy}
                  </div>
                  <div className="text-xs text-zinc-400 mt-0.5">Easy</div>
                </div>
                <div className="p-2 sm:p-2.5 bg-yellow-500/10 rounded-sm border border-yellow-500/20">
                  <div className="text-xl font-bold text-yellow-400">
                    {stats.medium}
                  </div>
                  <div className="text-xs text-zinc-400 mt-0.5">Medium</div>
                </div>
                <div className="p-2 sm:p-2.5 bg-red-500/10 rounded-sm border border-red-500/20">
